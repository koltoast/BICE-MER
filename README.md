# BlackIce Submod - Middle East Rework
	...
	Currently using BICE v2.5.8 files except for BMP_technologies.gfx and merBMP_Commonwealth_equipment_l_english.yml that might be from 2.4 but there's barely any point to bother with those at this point
